...
class ProductMain extends Component {
  ...
  changeQuantity() {
    const quantityInput = ReactDOM.findDOMNode(this.refs.quantityInput);
    ...
    return (
      <div>
        ...
        <div style={quantity} className="col-md-12 text-center">
          ...
          <input style={{width: '50px'}} type="number" value={this.state.quantity} ref="quantityInput" onChange={this.changeQuantity} />
        </div>

        <div style={purchase} className="navbar-fixed-bottom col-md-12 text-center">
          <input style={purchaseBtn} type="submit" value="Add To Cart" className="btn" onClick={this.addToCart} />
        </div>
